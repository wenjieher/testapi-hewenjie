...
# 读取用例
excelDir = '/Users/wenjiehe/Documents/GitHub/testapi-hewenjie/APItest/testmedia2020.xls'
# 打开表格
...
for one in range(1, 2):
    ...
    # print(token)
    res = test_resp.json()["data"][number1][dy]
    #res = token
    print(res)
...
workbookWr.save('/Users/wenjiehe/Documents/GitHub/testapi-hewenjie/APItest/result-testmedia2020.xls')
#发送邮件
#sen_email()
